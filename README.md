...
the doctor and admin only can login but the patients can login and register ,The patient can check the doctor's weekly schedule to help them to choose the day and time which they can comply for the appointment and they will submit their request for an appointment. After that, the doctors can view all their appointments and the appointment request of the patients for their availability.
the 
...
# Login Informations (you can Register as doctor or patietn but just login as Admin)

| Admin Dashboard         | Doctor Dashboard                    | Patient Dashboard           |
| ----------------------  | ------------------------------      |-----------------------------|
| Email: `admin@edoc.com` | Email: `ahmedelsayeed49@gmail.com`  | Email: `ali55@gmail.com`    | 
| Password: `123`         | Password: `772001`                  | Password: `a77a`            |
